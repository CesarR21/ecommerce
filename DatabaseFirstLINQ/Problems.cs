       ...
       private void ProblemThree()
        {
            ...
            var hiPricies = _context.Products.Where(p => p.Price > 150);
            foreach (var hipri in hiPricies)
            {
                Console.WriteLine(hipri.Name + " " + hipri.Price);
            }
        }
...
private void ProblemSeven()
        ...
        private void ProblemEight()
        {
            ...
            var productCustomer = _context.ShoppingCarts.Include(p => p.Product).Where(u => u.User.Email == "afton@gmail.com");
            foreach (ShoppingCart proId in productCustomer)
            {
                Console.WriteLine($"Product Name: {proId.Product.Name}  Price: {proId.Product.Price} Quantity: {proId.Quantity}");
            }
        }
        ...
        private void ProblemTwelve()
        {
            ...
            {
                Name = "Bose Headphones Wireless",
                Description = "Water resistant wireless headphone",
                Price = 299,
            };
        ...
        private void ProblemFourteen()
        {
            ...
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).SingleOrDefault();
            var productId = _context.Products.Where(r => r.Name == "Bose Headphones Wireless").Select(r => r.Id).SingleOrDefault();
        ...
        private void ProblemSixteen()
        {
            ...
            var product = _context.Products.Where(r => r.Name == "Bose Headphones Wireless").SingleOrDefault();
            product.Price = 316;
